...
function SignupForm() {
  ...
  const handleOnSubmit = (e) => {
    ...
    dispatch(sendOtp(formData.email,OTP_PURPOSE.SIGNUP, navigate))
  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        ...
        <button
          type="submit"
          className="mt-6 rounded-[8px] bg-yellow-100 hover:bg-yellow-50 py-[8px] px-[12px] font-medium text-richblack-900 
